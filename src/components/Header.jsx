...
export default function Header(props) {
  return (
    <div className='w-full bg-white items-center flex-row justify-between flex top-0  h-[10vh] sticky  border-b-2 mb-2 ' >
      ...
      <button onClick={props.toggler} data-modal-show="crud-modal" data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
  + New Ticket
</button>
